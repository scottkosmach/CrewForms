 ...
 * Edit Mapping Page
 * 
 * Form to edit an existing field mapping configuration.
 */
...
export default function EditMappingPage() {
  ...
  async function loadMapping() {
    try {
      ...
      const mapping: SiteMapping = await response.json();
      
      setName(mapping.name);
      setUrlPattern(mapping.urlPattern);
      setFormType(mapping.formType);
    ...
    <div className="admin-page">
      ...
      <header className="header">
        <div className="header-content">
          ...
          <h1 className="header-title">Edit Field Mapping</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="card">
            ...
            <div className="form-group">
              ...
              />
              <p className="form-hint">Use * as a wildcard</p>
            </div>
